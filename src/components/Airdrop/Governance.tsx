export default function Governance() {
    return (
        <section className="2xl:py-36 py-12 mt-12 text-center relative">
            <div className="site-width-sm ">
                <h2 className="h2-tag md:text-4xl font-bold text-white max-w-[900px] mx-auto">
  ...
  bg-linear-to-br from-[#184BFF] to-[#18b6ff]
