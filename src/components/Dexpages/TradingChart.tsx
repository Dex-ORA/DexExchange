...
export default function TradingChart({
    ...
    useEffect(() => {
        ...
        const widgetOptions: any = {
            ...
            disabled_features: [
                ...
                ...(window.innerWidth < 768 ? ["left_toolbar"] : [])
            ],
            enabled_features: [
                "study_templates",
            ...
            overrides: {
                ...
                "mainSeriesProperties.statusViewStyle.symbolTextSourceBackgroundColor": toolbarColor,
        ...
        tvWidget.onChartReady(() => {
            ...
            tvWidget.subscribe("onAutoSaveNeeded", () => {
                tvWidget.save((state: any) => {
                    localStorage.setItem("tv_layout_" + pair, JSON.stringify(state));
                });
            });
        });
    ...
    return (
        <div className="relative w-full h-[400px] md:h-[550px] bg-black/40 backdrop-blur-md overflow-hidden rounded-b-2xl border-x border-b border-white/5">
            {isLoading && (
