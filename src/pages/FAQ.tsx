        ...
        <div className="py-16 text-white">
            <div className="site-width-sm mx-auto px-6">
                ...
                <p className="p-tag mb-12 max-w-4xl">
                    Welcome to the Dexora Help Center. Find answers to the most common questions about our platform, features, and security. 
                </p>
...
const faqs = [
    {
        question: "What is Dexora?",
        answer:
            "Dexora is a high-performance decentralized exchange (DEX) specializing in perpetual futures trading. We combine the speed, deep liquidity, and low fees of traditional centralized exchanges with the security and self-custody of decentralized finance (DeFi). We operate on a high-speed Layer-2 network to ensure instant trade execution. ",
    },
    {
        question: "Do I need to create an account or pass KYC?",
        answer:
            " No. Dexora is a permissionless, non-custodial platform. You do not need to provide an email, create a password, or submit personal identification documents (KYC). To start trading, simply connect a compatible non-custodial crypto wallet (like MetaMask or Rabby).",
    },
    {
    ...
    {
        question: " Is Dexora available in my country?",
        answer:
            "Dexora is decentralized, but access to the interface may be restricted in certain jurisdictions due to local regulations (e.g., North Korea and Iran). Please review our Terms of Service to ensure you are eligible to trade.",
    ...
    },
    {
        ...
        answer:
            "- Currently, Dexora uses USDC (or specify your base asset) as the primary collateral for all trading pairs. You need to bridge USDC to your trading account to open positions.",
    ...
    },
    {
        ...
        answer:
            "Liquidity Vaults allow users to deposit assets (like USDC) to provide liquidity to the Dexora matching engine. The vault essentially acts as the counterparty to traders on the platform.  ",
        list: [
    ...
    {
        question: "What are the benefits of Staking Dexora tokens? ",
        answer:
    ...
    },
    {
        ...
        answer: "You can withdraw your funds at any time by bridging them back from the Dexora L2 network to your Ethereum L1 wallet via the “Withdraw” tab in your Portfolio. Withdrawals typically take a short period to process through the secure bridge.  "
    },
    {
        question: "Is Dexora safe? ",
    ...
    },
    {
        ...
        answer: "Because Dexora is non-custodial, we have absolutely no access to your wallet or private keys. If you lose access to your wallet, seed phrase, or private keys, your funds are lost forever. We cannot recover them for you. Please ensure you back up your seed phrase securely offline.  "
    }];
