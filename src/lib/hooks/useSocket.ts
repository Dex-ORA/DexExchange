      ...
      ws.onmessage = (e) => {
        try {
          ...
          if (msg.channel === "allDexsClearinghouseState") {
            ...
            const withdrawableVal = parseFloat(msg.data.portfolioMarginSummary?.withdrawable) || parseFloat(accountState.withdrawable) || parseFloat(marginSummary?.withdrawable) || parseFloat(msg.data.withdrawable) || parseFloat(msg.data.crossMarginSummary?.withdrawable) || 0;
            setWithdrawable(withdrawableVal);
